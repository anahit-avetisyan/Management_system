    ...
    <div class="register-container">
        <div class="form-container">
            <div class="form-container__content">
                 <p class="register__form--header">Login form</p>
                <div class="register__form--horizontal" >
                        ...
                        <label class="form__input--label">
                            ...
                            <span class="error-message" v-if="typeof(errorsPassword)=='string'">{{errorsPassword}}</span>
                            <div v-else class="error-message-container" v-for="(error,index) in errorsPassword" :key="index">
                                <span class="error-message" >{{error}}</span>
                            </div>
                        </label>
                    <div class="form-group-buttons">
                        <div >
                            <button  @click="register" class="add-button btn">Sign in</button>
                            <router-link
                                to="/home"
                                class="cancel-btn"
